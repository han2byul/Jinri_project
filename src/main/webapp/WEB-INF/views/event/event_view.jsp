...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/event/event_view.css">
      ...
      <div class="box">
        <aside>
          ...
          <ul>
			...
			<div>
				<div>
					<div class="top">작성자: <span>${vo.id }</span>&nbsp;  | &nbsp;작성일: <span>${vo.regdate}</span> </div>
			...
			<div style="text-align:center;">
						<img src="${pageContext.request.contextPath}/resources/upload/${vo.filename}" width="500" height="610"/>	
		   </div>
	</div>
            ...
            <div class="main">
             <div style="text-align: center;">
                  <input type="button" value="목록으로" id="btn" onclick="location.href='eventlist.do?page=${param.page}'">
              </div>
