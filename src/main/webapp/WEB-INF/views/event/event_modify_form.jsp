...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/event/event_modify_list.css">
	       ...
	       <div class="main">
                ...
                <div class="loc_history">
                  홈  &nbsp;>&nbsp; 열린공간 &nbsp;> &nbsp; <b> 행사안내 </b>
                   ...
                   <h3 style="margin:20px 0;">수정하기</h3>
                   
    <form method="post" action="eventmodify.do?idx=${vo.idx}&page=${empty param.page ? 1:param.page}">
		  <div>
						  <input type="hidden" name="idx" value="${vo.idx}">
                            ...
                            <table id="req" border="1" width="100%">
                                ...
                                <tr>
                                    <th>제목</th>
                                    <td colspan="3"><input name="title" value="${vo.title}"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="padding:20px;">
                                        ...
                                        <textarea id="op" rows="10" name="content">${vo.content}</textarea>
                            ...
                            <div>
								...
								<input type="button" value="목록" class="btn" onclick="location.href='eventlist.do?page=${param.page}'">
                        	</div>
                        </div>
				</form>
			</div>
