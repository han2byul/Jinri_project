...
<script src="${pageContext.request.contextPath}/resources/js/qnajs/qna_write.js"></script>
   ...
   <div class = "box">
        <aside>
    		...
    		<div class = "main">
                ...
                <form method="post" action="qna_insert.do?id=${ user.id }&page=${empty param.page ? 1 : param.page}">
