  ...
  <header>
   ...
   <section class="navigation box">
    ...
    <section class="main">
        ...
        <div class="center">
            <a href="main.do"><img src="${pageContext.request.contextPath}/resources/img/join.png"></a>
             </div><br>

        <dl class="accordion">
            <dt><a href="#">온라인 발급</a></dt>
            <dd> 
                <h2>회원가입 방법(온라인)</h2><br><br>
                <ul>
                    <li>홈페이지 회원가입은 진리도서관 홈페이지에서 신청이 가능합니다.</li><br>
                    <li>홈페이지 회원으로 가입하시면 온라인상의 다양한 서비스를 이용하실 수 있습니다.
                    </li><br>
                    <li>기존에 회원증만 발급받으신 이용자님께서는 홈페이지 아이디등록도 하셔야 온라인상의 대출 조회, 대출 자료 연장, 도서 예약 등의 서비스를 이용하실 수 있습니다.
                    </li><br>
                    <li>홈페이지 회원만 가입하신 이용자님께서는 도서관 방문 후 회원증을 발급받으셔야 도서대출 및 도서관의 모든 서비스를 이용하실 수 있습니다.
                    </li><br>
        
                </ul></dd>
             <dt><a href="#">오프라인 발급</a></dt>
             <dd> <h2>회원가입 방법(오프라인)</h2><br><br>
                <h3>도서관 방문</h3>
                <ul>
